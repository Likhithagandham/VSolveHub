...
const CONTACT_EMAIL = 'hello@vsolvehub.com';
const CONTACT_ADDRESS = 'VSolveHub HQ, HITEC City, Hyderabad, Telangana 500081';
const MAPS_EMBED_URL = 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3806.123456789!2d78.3762!3d17.4484!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMTfCsDI2JzU0LjIiTiA3OMKwMjInMzQuNCJF!5e0!3m2!1sen!2sin!4v1700000000000!5m2!1sen!2sin';
...
function getCategoryCatalog(categoryId) {
...
const ARROW_SVG = '<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M7 17L17 7M17 7H9M17 7v8"/></svg>';
...
function getBooking() {
  try {
    return JSON.parse(sessionStorage.getItem('vsh_booking'));
  } catch {
    return null;
  }
}

function isReturningUser(phone) {
  const users = JSON.parse(localStorage.getItem('vsh_users') || '[]');
  return users.includes(phone);
}

function markUserRegistered(phone) {
  const users = JSON.parse(localStorage.getItem('vsh_users') || '[]');
